...
def test_record_and_check_health(tmp_path):
    ...
    record_run_result(date(2026, 7, 1), "morning", True, {"llm": True, "email": True}, health_file)
    record_run_result(date(2026, 7, 1), "evening", True, {"llm": False, "email": True}, health_file)
    record_run_result(date(2026, 7, 2), "morning", True, {"llm": False, "email": True}, health_file)
    record_run_result(date(2026, 7, 2), "evening", True, {"llm": False, "email": True}, health_file)
